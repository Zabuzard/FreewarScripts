					...
					<tr>\
						<td width="95%">\
							Nr. <b>' + fastspellId + '</b>: <a href="item.php?action=activate&act_item_id=' + itemId
								+ '&itemcheckid=1772814588" onclick="this.href += \'&yscroll=\' + window.pageYOffset;this.href = this.href.replace(/(itemcheckid=)[0-9]+/, \'$1\' + Math.floor(((parent.frames.reloadChatFrame.server_time_offset || 0) + Date.now()) / 1000));">' + itemName + '</a>\
						</td>\
						<td valign="top">\
...
// 2: geklebte, gelbe Zauberkugel
// 3: Seelenkapsel
// 4: Seelenkugel
//fastspellData['1']['5'] = [247183411, '_____Portalmaschine'];
...
fastspellData['2']['1'] = [247183405, 'Makibishi'];
fastspellData['2']['2'] = [247183515, 'eisiger Teleporter'];
fastspellData['2']['3'] = [247183431, 'Schriftrolle der Lebenden'];
fastspellData['2']['4'] = [247183574, 'Zauberkugel-Klebemaschine'];
fastspellData['2']['5'] = [247183458, 'Korallen-Seelen-Misch-O-Mat'];
fastspellData['2']['6'] = [265514333, 'Pfeilbeutel'];
fastspellData['2']['7'] = [247183543, 'Barubeutel'];
fastspellData['2']['8'] = [247183539, 'Stab des Wissens'];
fastspellData['2']['9'] = [807290486, 'Stab des Handels'];
*/
